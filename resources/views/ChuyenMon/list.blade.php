...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">List Chuyên Môn</div>
    </div>
	        ...
	        <div class="col-lg-12">
	            <div class="panel panel-blue">
	            	<div class="panel-heading">
	            		...
	            		<!-- <p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="fa fa-plus"></span>&nbsp;Add</button></p> -->
	            	</div>
	...
	<div class="modal-dialog">
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      	...
	      	<div class="form-group">
	        	<input class="form-control " type="text" placeholder="Xin Hãy nhập vào tên chuyên môn">
	      	</div>
	      	<div class="form-group">
	    		<label for="inputFirstName" class="control-label">Mã Chuyên Môn <span class='require'>*</span></label>
	    	</div>
	      	<div class="form-group">
	        	<input class="form-control " type="text" placeholder="Xin Hãy nhập vào mã chuyên môn">
	      	</div>
	    </div>
	    <div class="modal-footer ">
