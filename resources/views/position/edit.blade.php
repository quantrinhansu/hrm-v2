  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
    	<div class="form-group">
		  ...
		  <input class="form-control" id="description" name="code" type="text" placeholder="Xin Hãy nhập mã chức vụ" value="{{$position['code']}}">
		</div>
    	<div class="form-group">
    		<label for="inputFirstName" class="control-label">Tên Chức Vụ <span class='require'>*</span></label>
    	</div>
      	<div class="form-group">
        	<input class="form-control" name="name" id="name" type="text" placeholder="Xin Hãy nhập tên chức vụ" value="{{$position['name']}}">
        	<input class="form-control" name="id" id="id" type="hidden" value="{{$position['id']}}">
      	</div>
    </div>
    </form>
