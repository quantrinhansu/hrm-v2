...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">List Chức Vụ</div>
    </div>
	...
	<div class="modal-dialog">
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      ...
	      <div class="form-group">
	        <input class="form-control " type="text" placeholder="Xin Hãy nhập vào tên chức vụ">
	      </div>
	      <div class="form-group">
	    		<label for="inputFirstName" class="control-label">Mã Chức Vụ <span class='require'>*</span></label>
	    	</div>
	      <div class="form-group">
	        <input class="form-control " type="text" placeholder="Xin Hãy nhập vào mã chức vụ">
	      </div>
	    </div>
	    <div class="modal-footer ">
